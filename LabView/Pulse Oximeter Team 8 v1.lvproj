...
AddOutputFilter chunkFilter
		...
		<Item Name="Data Acqu (SubVI).vi" Type="VI" URL="../Data Acqu (SubVI).vi"/>
		<Item Name="Display (SubVI).vi" Type="VI" URL="../Display (SubVI).vi"/>
		<Item Name="Frequency Analysis (SubVI).vi" Type="VI" URL="../Frequency Analysis (SubVI).vi"/>
		<Item Name="Heart Rate (SubVI).vi" Type="VI" URL="../Heart Rate (SubVI).vi"/>
		<Item Name="Illuminace (SubVI).vi" Type="VI" URL="../Illuminace (SubVI).vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="SPO2 (SubVI).vi" Type="VI" URL="../SPO2 (SubVI).vi"/>
		<Item Name="Test Waveform Components (SubVI).vi" Type="VI" URL="../Test Waveform Components (SubVI).vi"/>
		<Item Name="Test_conditioning_circuitvi.vi" Type="VI" URL="../Test_conditioning_circuitvi.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
